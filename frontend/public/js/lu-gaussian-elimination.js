document.addEventListener("DOMContentLoaded", function() {
    ...
    if (!window.location.pathname.startsWith('/lu-gaussian-elimination')) {
        return;
    }

    console.log("LU Gaussian elimination page loaded");
    ...
    form.addEventListener('submit', function(event) {
        ...
        fetch(`${currentUrl()}/api/v1/lu-gaussian-elimination?${params.toString()}`, {
            method: 'POST'
        })
